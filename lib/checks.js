...
exports.widgetChecks = function(obj, index) {
    ...
    if (!utilities.isValidString(obj.json)) {
        console.log(('"json" is missing from the object at index ' + index + ' in app.js').bold.red);
        return false;
    }
    return true;
};
...
exports.standardChecks = function(obj, index) {
    ...
    if (!utilities.isValidString(obj.description)) {
        ...
        console.log(('Warning: "description" is missing from the object at index ' + index + ' in app.js').bold.red);
    }
    if (!utilities.isValidString(obj.url)) {
        console.log(('"url" is missing from the object at index ' + index + ' in app.js').bold.red);
        return false;
